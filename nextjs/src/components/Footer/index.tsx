                ...
                <Row xs={1} sm={2} md={3} className='justify-content-between'>
                    ...
                    <Col as='address' md={5} lg={4} className='mt-sm-0'>
                        <ul className={footer.contact}>
                            ...
                            <Breadcrumb as='li' style={{ '--bs-breadcrumb-divider': '"·"' } as React.CSSProperties}>
                                <Breadcrumb.Item href='https://www.facebook.com/demac.company/' target='_blank' title='Facebook'>
                                    <i className='h5 mx-1 bi bi-facebook' />
                                </Breadcrumb.Item>
                                <Breadcrumb.Item href='' title='linkedIn'>
                                    <i className='h5 mx-1 bi bi-linkedin' />
                                </Breadcrumb.Item>
                                <Breadcrumb.Item href='https://api.whatsapp.com/send?phone=201099747581' title='Whatsapp'>
