...
export default function Header({ h1, h2, classNames, showSeperator }: Header) {
    return (
        <header className={(classNames?.parent ?? 'bg-dark ')}>
            <div className={'pt-3 divider ' + (classNames?.child ?? '')}>
                ...
                {showSeperator && <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
